...
const OwnerDetailsScreen = () => {
  ...
  const handleUpdateIsActive = async () => {
    try {
      const response = await axios.post(API_ENDPOINT_update, {
              ...
              <View style={styles.table}>
                ...
                <View style={styles.row}>
                  ...
                  <Text
                    style={
                      styles.cell
                    }>{`${ownerData.owner.FirstName} ${ownerData.owner.MiddleName} ${ownerData.owner.LastName}`}</Text>
                </View>
                <View style={styles.row}>
                  <Text style={styles.cellHeader}>Mobile</Text>
                  <Text style={styles.cell}>
                    {ownerData.owner.MobileNumber}
                  </Text>
                </View>
                <View style={styles.row}>
                ...
                <View style={styles.row}>
                  ...
                  <Text style={styles.cell}>
                    {ownerData.owner.NumberOfMembers}
                  </Text>
                </View>
              </View>
            </View>
                ...
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <View style={styles.property}>
                      ...
                      <View style={styles.row}><Text style={styles.cellHeader}>Mode:</Text>
                      <Text style={styles.cell}>{item.PropertyMode}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Age:</Text>
                      <Text style={styles.cell}>{item.PropertyAge}</Text>
                      {/* </View><View style={styles.row}><Text style={styles.cellHeader}>Rooms:</Text>
                      <Text style={styles.cell}>{item.RoomCount}</Text> */}
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Floors:</Text>
                      <Text style={styles.cell}>{item.FloorCount}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>shop:</Text>
                      <Text style={styles.cell}>{item.shopCount}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Tenant:</Text>
                      <Text style={styles.cell}>{item.TenantCount}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>TenantRent:</Text>
                      <Text style={styles.cell}>{item.TenantYearlyRent}</Text>

                      </View><View style={styles.row}><Text style={styles.cellHeader}>ZoneID:</Text>
                      <Text style={styles.cell}>{item.ZoneID}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Locality:</Text>
                      <Text style={styles.cell}>{item.Locality}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Colony:</Text>
                      <Text style={styles.cell}>{item.Colony}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Galli:</Text>
                      <Text style={styles.cell}>{item.GalliNumber}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>House No:</Text>
                      <Text style={styles.cell}>{item.HouseNumber}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>House Type:</Text>
                      <Text style={styles.cell}>{item.HouseType}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Open Area:</Text>
                      <Text style={styles.cell}>{item.OpenArea}</Text>
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Constructed Area:</Text>
                      <Text style={styles.cell}>{item.ConstructedArea}</Text>
                      {/* </View><View style={styles.row}><Text style={styles.cellHeader}>BankAccount:</Text>
                      <Text style={styles.cell}>{item.BankAccountNumber}</Text> */}
                      </View><View style={styles.row}><Text style={styles.cellHeader}>Water Harvesting:</Text>
                      <Text style={styles.cell}>
                        {item.WaterHarvesting ? 'Yes' : 'No'}
                      </Text>
                      </View>
                      <View style={styles.row}>
                      <Text style={styles.cellHeader}>Submersible:</Text>
                      <Text style={styles.cell}>
                        {item.Submersible ? 'Yes' : 'No'}
                      </Text>
                      </View>
                      <View style={styles.row}>
              ...
              <FlatList
                ...
                renderItem={({item}) => (
                  <View style={styles.consideration}>
                    <View style={styles.row}><Text style={styles.cellHeader}>Consideration ID:</Text>
                    <Text style={styles.cell}>{item.ConsiderationID}</Text>
                    </View><View style={styles.row}><Text style={styles.cellHeader}>Type:</Text>
                    <Text style={styles.cell}>{item.ConsiderationType}</Text>
                    </View><View style={styles.row}><Text style={styles.cellHeader}>Description:</Text>
                    <Text style={styles.cell}>{item.Description}</Text>
                    </View><View style={styles.row}><Text style={styles.cellHeader}>GeoLocation:</Text>
            ...
            {updateSuccess && (
              <View style={styles.successContainer}>
                <Text style={styles.successText}>
                  IsActive status updated successfully!
                </Text>
              </View>
            )}
          </>
